...
map('n', '<leader><leader>w', '<cmd>HopWordAC<CR>', options)
map('n', '<leader><leader>b', '<cmd>HopWordBC<CR>', options)
map('n', '<leader><leader>k', '<cmd>HopLineBC<CR>', options)
map('n', '<leader><leader>j', '<cmd>HopLine<CR>', options)
