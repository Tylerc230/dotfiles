...
map('n', '<leader>Mm', '<cmd>lua require("harpoon.ui").toggle_quick_menu()<CR>', options)
map('n', '<leader>Ma', '<cmd>lua require("harpoon.mark").add_file()<CR>', options)
...
map('n', '<leader>T', ':Telescope toggleterm<CR>', options)
